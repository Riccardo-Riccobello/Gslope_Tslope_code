...
BoxPlot_simulation_tstudent <- function(N, p, graph_type, v, u, i){
  ...
  data_cond <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( cond$cond_sample, cond$cond_glasso, cond$cond_elastic,
             cond$cond_rope, cond$cond_tlasso, cond$cond_gslope, cond$cond_tslope))
  
  data_frob <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( frob$frob_sample, frob$frob_glasso, frob$frob_elastic,
             frob$frob_rope, frob$frob_tlasso, frob$frob_gslope, frob$frob_tslope))
  
  data_TP <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( TP_rt$TP_sample, TP_rt$TP_glasso, TP_rt$TP_elastic,
  ...
  data_TN <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( TN_rt$TN_sample, TN_rt$TN_glasso, TN_rt$TN_elastic,
  ...
  data_FN <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( FN_rt$FN_sample, FN_rt$FN_glasso, FN_rt$FN_elastic,
             FN_rt$FN_rope, FN_rt$FN_tlasso, FN_rt$FN_gslope, FN_rt$FN_tslope))
  
  data_F1 <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( F1$F1_sample, F1$F1_glasso, F1$F1_elastic,
             F1$F1_rope, F1$F1_tlasso, F1$F1_gslope, F1$F1_tslope))
  
  data_ACC <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( Acc$ACC_sample, Acc$ACC_glasso, Acc$ACC_elastic,
             Acc$ACC_rope, Acc$ACC_tlasso, Acc$ACC_gslope, Acc$ACC_tslope))
  
  data_entropy <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( Entropy$entropy_sample, Entropy$entropy_glasso, Entropy$entropy_elastic,
             Entropy$entropy_rope, Entropy$entropy_tlasso, Entropy$entropy_gslope, Entropy$entropy_tslope))
  
  data_FDR <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( FDR_data$FDP_sample, FDR_data$FDP_glasso, FDR_data$FDP_elastic,
             FDR_data$FDP_rope, FDR_data$FDP_tlasso, FDR_data$FDP_gslope, FDR_data$FDP_tslope))
  
  data_localFDR <- data.frame(
    name=c( rep("Sample",i), rep("Glasso",i), rep("Elastic",i), rep("Rope",i),
            rep("Tlasso",i), rep("Gslope",i), rep("Tslope",i)),
    value=c( localFDR_data$localFDP_sample, localFDR_data$localFDP_glasso, localFDR_data$localFDP_elastic,
